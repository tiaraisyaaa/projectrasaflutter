...
class _ConnectedElderliesScreenState extends State<ConnectedElderliesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Lansia Terhubung'),
                ...
                child: _elderlies.isEmpty
                    ? ListView(
                        ...
                        children: const [
                          ...
                          Center(
                            child: Text(
                              'Lansia yang sudah terhubung akan tampil di sini.',
                    ...
                    : ListView.builder(
                        padding: const EdgeInsets.all(24),
                        itemCount: _elderlies.length,
                        itemBuilder: (context, index) {
                          return _buildElderlyCard(_elderlies[index]);
                        },
                      ),
              ),
      ),
